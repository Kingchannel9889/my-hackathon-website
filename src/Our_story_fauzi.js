       ...
       <div id="carouselExampleControls" className="carousel slide" data-ride="carousel">
         <div className="carousel-inner">
           <div className="carousel-item active">
             <img className="ml-5 d-block w-50 carousel-image" src="image1.jpg"  alt="First slide" />
           </div>
           <div className="carousel-item">
             <img className="ml-5 d-block w-50 carousel-image" src="image2.jpg" alt="Second slide" />
           </div>
           <div className="carousel-item">
             <img className="ml-5 d-block w-50 carousel-image" src="image3.jpg" alt="Third slide" />
           </div>
         </div>
